...
function App() {
  ...
  useEffect(() => {
    const handleNavClick = (e) => {
      ...
      if (href && href.startsWith("#")) {
        ...
        if (target) {
          // scrollIntoView native tetap dipakai, tapi di CSS kita tambahkan scroll-mt-28
  ...
  // Animasi Diperhalus (Mencegah rasa "nabrak")
  const fadeUp = {
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-8">
        ...
        >
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            {/* Animasi diperhalus agar tidak nabrak */}
            <motion.div
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
           ...
           {/* Github (Animasi Hidup Kembali & Bisa Diklik) */}
            ...
            {/* Letterboxd */}
            <div
              className={`col-span-1 md:col-span-12 lg:col-span-7 relative overflow-hidden p-6 md:p-8 rounded-[2rem] border flex flex-col group transition-all duration-300 hover:-translate-y-1 ${isDarkTheme ? "bg-[#0a0a0a]/80 border-white/5 hover:border-orange-500/30" : "bg-white border-black/5 hover:border-orange-500/30"}`}
            >
              <div className="flex justify-between items-center mb-6">
            ...
            {/* Learning */}
            <div
              className={`col-span-1 md:col-span-12 lg:col-span-6 relative overflow-hidden p-6 md:p-8 rounded-[2rem] border flex flex-col group transition-all duration-300 hover:-translate-y-1 ${isDarkTheme ? "bg-[#0a0a0a]/80 border-white/5" : "bg-white border-black/5"}`}
            >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 mt-16">
              {listTools.map((tool) => (
                <motion.div
                  ...
                  className={`group relative p-6 rounded-3xl border flex flex-col items-center justify-center gap-4 overflow-hidden backdrop-blur-sm cursor-pointer ${
                    isDarkTheme
                ...
                >
                  ...
                  <div className="relative w-16 h-16 flex items-center justify-center">
                    <div
                      className={`absolute inset-0 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${isDarkTheme ? "bg-white/20" : "bg-black/10"}`}
                    ></div>
                    <motion.img
                      src={tool.gambar}
                      alt={tool.nama}
                      className="w-12 h-12 object-contain relative z-10 drop-shadow-lg will-change-transform"
                  ...
                  <div className="flex flex-col items-center text-center relative z-10">
                    ...
                    <p
                      className={`text-[10px] font-bold tracking-widest uppercase mt-1.5 transition-colors ${
                        isDarkTheme
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-start">
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      className={`w-14 h-14 shrink-0 rounded-full flex items-center justify-center border transition-all duration-300 ${isDarkTheme ? "bg-[#111] border-white/10 group-hover:border-white/50 group-hover:shadow-[0_0_15px_rgba(255,255,255,0.15)]" : "bg-white border-black/10 shadow-sm"}`}
                    >
                      <i
